...
namespace Solti.Utils.DI.Interfaces
{
    public static partial class IServiceContainerBasicExtensions
    {
        ...
        public static IServiceContainer Factory(this IServiceContainer self, Type iface, string? name, Func<IInjector, Type, object> factory, Lifetime lifetime)
        {
            if (self == null)
            ...
            self.Add(lifetime.CreateFrom(iface, name, factory, self));
            return self;
        }
        ...
        /// <returns>The container itself.</returns>
        /// <remarks>You can register generic services (where the <paramref name="iface"/> parameter is an open generic type).</remarks>
        public static IServiceContainer Factory(this IServiceContainer self, Type iface, Func<IInjector, Type, object> factory, Lifetime lifetime) 
        ...
        /// <param name="lifetime">The <see cref="Lifetime"/> of the service.</param>
        /// <returns>The container itself.</returns>
        public static IServiceContainer Factory<TInterface>(this IServiceContainer self, string? name, Func<IInjector, TInterface> factory, Lifetime lifetime) where TInterface : class
        ...
        /// <param name="lifetime">The <see cref="Lifetime"/> of the service.</param>
        /// <returns>The container itself.</returns>
        public static IServiceContainer Factory<TInterface>(this IServiceContainer self, Func<IInjector, TInterface> factory, Lifetime lifetime) where TInterface : class
