...
namespace Solti.Utils.DI.Interfaces
{
    ...
    /// </summary>
    /// <remarks>At the moment <typeparamref name="TInterceptor"/> should be either <see cref="Type"/> or Expression&lt;Func&lt;<see cref="IInjector"/>, <see cref="Type"/>, <see cref="object"/>, <see cref="object"/>&gt;&gt;.</remarks>
