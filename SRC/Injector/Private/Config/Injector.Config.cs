...
namespace Solti.Utils.DI.Internals
{
    ...
    /// <summary>
    /// Defines some options to control the behavior of the <see cref="IInjector"/> objects.
    /// </summary>
    public class InjectorConfig
    {
        ...
        /// </summary>
        public bool StrictDI { get; set; } = Config.GetValue<bool?>("Injector.StrictDI") ?? false;

        /// <summary>
        /// The maximum number of <see cref="Lifetime.Transient"/> service instances can be held by the <see cref="IInjector"/>.
        /// </summary>
        public int MaxSpawnedTransientServices { get; set; } = Config.GetValue<int?>("Injector.MaxSpawnedTransientServices") ?? 512;
    }
