...
namespace Solti.Utils.DI
{
    ...
    public static class IInjectorAdvancedExtensions
    {
        ...
        public static object Instantiate(this IInjector self, Type @class, object explicitArgs)
        {
            ...
            return ServiceActivator.GetExtended(@class, explicitArgs.GetType()).Invoke(self, explicitArgs);
        }
        ...
        /// </remarks>
        /// <exception cref="ServiceNotFoundException">One or more dependecies could not be found.</exception>
        public static TClass Instantiate<TClass>(this IInjector self, IReadOnlyDictionary<string, object?>? explicitArgs = null) where TClass : class => (TClass) self.Instantiate(typeof(TClass), explicitArgs);
