...
namespace Solti.Utils.DI
{
    ...
    public interface ITypeResolver
    {
        ...
        bool Supports(Type iface);

        /// <summary>
        /// Resolves the implementation of the given interface.
        /// </summary>
        /// <param name="iface">The service interface whose implementation is requested. It can be an open generic type. In this case the returned implementation must also be an open generic type.</param>
