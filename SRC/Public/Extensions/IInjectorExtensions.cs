...
namespace Solti.Utils.DI
{
    ...
    public static class IInjectorExtensions
    {
        ...
        public static TInterface Get<TInterface>(this IInjector self) => self != null ? (TInterface) self.Get(typeof(TInterface), null) : throw new ArgumentNullException(nameof(self));
