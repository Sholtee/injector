...
namespace Solti.Utils.DI.Internals
{
    ...
    {
        public override bool ShouldUse(IInjector injector, AbstractServiceEntry requested) => requested.Owner != null && injector.UnderlyingContainer.IsDescendantOf(requested.Owner);
