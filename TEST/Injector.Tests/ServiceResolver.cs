...
namespace Solti.Utils.DI.Internals.Tests
{
    ...
    internal sealed class ServiceResolverTests
    {
        ...
        {
            SingletonServiceEntry entry = new(typeof(IList), name, (_, _) => new List<object>(), false);
        ...
        {
            ScopedServiceEntry entry = new(typeof(IList), name, (_, _) => new List<object>(), false);
        ...
        {
            TransientServiceEntry entry = new(typeof(IList), name, (_, _) => new List<object>(), false);
        ...
        {
            ScopedServiceEntry entry = new(typeof(IList<>), name, typeof(MyLiyt<>), false);
        ...
        {
            ScopedServiceEntry
                entry1 = new(typeof(IList), 0.ToString(), typeof(MyLiyt<object>), false),
                entry2 = new(typeof(IList), 1.ToString(), typeof(MyLiyt<object>), false);
        ...
        {
            ScopedServiceEntry
                entry1 = new(typeof(IList), name, typeof(MyLiyt<object>), false),
                entry2 = new(typeof(IDisposable), name, typeof(MyDisposable), false);
        ...
        public void Resolver_ShouldSpecializeOnlyIfTheConstructedGenericServiceCannotBeFound([Values(null, "cica")] string name, [Values(ServiceEntryLookupBuilder.DICT, ServiceEntryLookupBuilder.BTREE)] string engine, [Values(ServiceResolutionMode.JIT, ServiceResolutionMode.AOT)] ServiceResolutionMode resolutionMode)
        {
            TransientServiceEntry 
                genericEntry = new(typeof(IList<>), name, typeof(MyLiyt<>), false),
                specializedEntry = new(typeof(IList<int>), name, typeof(MyLiyt<int>), false);
        ...
        {
            TransientServiceEntry genericEntry = new(typeof(IList<>), name, typeof(MyLiyt<>), false);
        ...
        {
            ScopedServiceEntry genericEntry = new(typeof(IList<>), name, typeof(MyLiyt<>), false);
        ...
        {
            Assert.IsNull(ServiceEntryLookupBuilder.Build(new AbstractServiceEntry[] { new ScopedServiceEntry(typeof(IList<object>), null, typeof(MyLiyt<object>), false) }, new ScopeOptions { ServiceResolutionMode = resolutionMode, Engine = engine }).Get(typeof(IList<int>), null));
        }
        ...
        {
            Assert.IsNull(ServiceEntryLookupBuilder.Build(new AbstractServiceEntry[] { new ScopedServiceEntry(typeof(IList), 0.ToString(), typeof(MyLiyt<object>), false) }, new ScopeOptions { ServiceResolutionMode = resolutionMode, Engine = engine }).Get(typeof(IList), null));
        }
    }
}
