...
namespace Solti.Utils.DI.Tests
{
    ...
    public partial class InjectorTests
    {
        ...
        public void GetDependencyGraph_ShouldHandleComplexGraphs()
        {
            ...
            (
                svcs => svcs
                    .Factory(injector => (IInterface_1) (object) new { Dep1 = injector.Get<IInterface_2>(null), Dep2 = injector.Get<IInterface_3<int>>(null) }, Lifetime.Singleton)
                    .Factory(injector => (IInterface_2) (object) new { Dep1 = injector.TryGet<IInterface_4>(null) /*non-exsiting*/, Dep2 = injector.Get<IInterface_7<object>>("cica") }, Lifetime.Scoped)
