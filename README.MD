...
```
As you can see there is no need for registering the `ParameterValidatorProxy<>` manually. Note that this feature is available since version 2.0.0 of the library.
### Auto config
